/*
    WiFi <-> LWIP driver for the nRF7002 chip on the Challenger RP2040 WiFi6

    Copyright (c) 2022 Pontus Oldberg, <pontus@ilabs.se>
...
public:
    ...
    */
    nRF7002(int8_t cs, arduino::SPIClass& spi, int8_t intrpin);
